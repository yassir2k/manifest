<div class="fcta-header">
  ...
  <nav class="navbar  bg-success" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:10px">
  	...
  	<div class="btn-group d-flex d-inline ">
    	<button type="button" class="btn btn-sm btn-success btn-block"><i class="fa fa-home"></i>	Dashboard</button>
    </div>
    ...
    <div class="btn-group d-flex">
      ...
      <div class="dropdown-menu" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:14px">
      	<a class="dropdown-item active bg-success" href="#"><i class="fa fa-certificate"></i>	Registry</a>
    ...
    <div class="v-divider"></div>
    <div class="btn-group d-flex">
    	<button type="button" class="btn btn-success btn-sm btn-block"><i class="fa fa-sign-out"></i>Logout</button>
    </div>

...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge">
  <link rel="stylesheet" href="css/manifest-css-mr.css">
  <link rel="stylesheet" href="css/bootstrap.min.css">
  <link rel="stylesheet" href="css/font-awesome.min.css">
  <link rel="stylesheet" href="css/bootstrap-toggle.min.css">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">

  <title>E - Despatch: Mail Room (Post Incorporation)</title>
</head>
...
<body>
   ...
   <!-- ------------------------------------ Beginning of Navigation-------------------------------------- -->
	<?php require("menus/pmenu_mail_room_dashboard.php");?>
   <!-- ---------------------------------------End of Navigation------------------------------------------- -->
        ...
        <div class="col-sm-8"> <!--Main Row Left-->
            <div class="row"><!--Manifest Statistics Registry-->
                ...
                <div class="col-sm-6" align="center">
                    <h6 class="text-success" align="center"><b>Today's Manifest Statistics (Registry)</b></h6>
                </div>
                <div class="col-sm-3" align="center">
                    <hr class="separator">
                </div>
			...
			<?php 
				...
				$sql = "SELECT count(*) as Total FROM tbl_RGs_office where convert(varchar(10), ";
				$sql.= "REG_Receiving_Date, 102) = convert(varchar(10), getdate(), 102) AND (RGO_Despatch_Status = 'A-B-R' AND State_Code='$scode') ";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
			...
			<div class="row"><!--Beginning of Putting Up Stats For Registry-->
                <div class="col-sm-4" align="center">
                    <div class="card bg-white mb-3 shadow-sm" style="width: 13rem;">
						<div class="card-body">
							...
							<hr class="separator">
							<p class="card-text"><b class="font-pref14">TOTAL GENERATED/SENT</b></p>
						</div>
					</div>
                </div>
                <div class="col-sm-4" align="center">
				...
				<?php 
				//Total Generated/Sent (Trustees)
				$sql = "SELECT count(*) as Total FROM tbl_RGs_office where convert(varchar(10), ";
				$sql.= "RGO_Cert_Despatch_Date, 102) = convert(varchar(10), getdate(), 102) AND (RGO_Despatch_Status = 'S-T-T' ";
				$sql.= "OR RGO_Despatch_Status = 'A-B-T')  AND State_Code='$scode'";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
				...
				//Total Pending with Trustees
				$sql = "SELECT count(*) as Total FROM tbl_RGs_office where convert(varchar(10), ";
				$sql.= "RGO_Cert_Despatch_Date, 102) = convert(varchar(10), getdate(), 102) AND (RGO_Despatch_Status = 'S-T-T')  AND State_Code='$scode'";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
				...
				//Total Acknowledged by Trustees
				$sql = "SELECT count(*) as Total FROM tbl_RGs_office where convert(varchar(10), ";
				$sql.= "IT_Receiving_Date, 102) = convert(varchar(10), getdate(), 102) AND (RGO_Despatch_Status = 'A-B-T')  AND State_Code='$scode'";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
			...
			<div class="row top-space20" ><!--Manifest Statistics IT-->
                ...
                <div class="col-sm-6" align="center">
                    <h6 class="text-success" align="center"><b>Today's Manifest Statistics (IT)</b></h6>
                </div>
                <div class="col-sm-3" align="center">
                    <hr class="separator">
                </div>

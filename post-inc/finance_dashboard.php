...
<head>
  ...
  <title>E - Despatch: Finance (Post Incorporation)</title>
</head>
...
<body>
   ...
   <!-- ------------------------------------ Beginning of Navigation-------------------------------------- -->
	<?php require("menus/pmenu_finance_dashboard.php");?>
   <!-- ---------------------------------------End of Navigation------------------------------------------- -->
        ...
        <div class="col-sm-8"> <!--Main Row Left-->
            <div class="row"><!--Manifest Statistics Registry-->
                ...
                <div class="col-sm-6" align="center">
                    <h6 class="text-success" align="center"><b>Receipts (RRR) Statistics for Today</b></h6>
                </div>
                <div class="col-sm-3" align="center">
                    <hr class="separator">
                </div>
                ...
                <div class="col-sm-4" align="center">
                    <div class="card bg-white mb-3 shadow-sm" style="width: 13rem;">
						<div class="card-body">
							...
							<hr class="separator">
							<p class="card-text"><b class="font-pref14">CONFIRMED</b></p>
						</div>
					</div>
                </div>
                <div class="col-sm-4" align="center">
                    <div class="card bg-white mb-3 shadow-sm" style="width: 13rem;">
						<div class="card-body">
							...
							<hr class="separator">
							<p class="card-text"><b class="font-pref14">REJECTED</b></p>
						</div>
					</div>
                </div>
			...
			<div class="row top-space20" ><!--Manifest Statistics IT-->
                ...
                <div class="col-sm-6" align="center">
                    <h6 class="text-success" align="center"><b>Receipts (RRR) Statistics Since Inception</b></h6>
                </div>
                <div class="col-sm-3" align="center">
                    <hr class="separator">
                </div>

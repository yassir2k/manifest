  <nav class="navbar  bg-success" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:10px">
  	...
  	<div class="btn-group d-flex d-inline ">
    	<button type="button" class="btn btn-sm btn-success btn-block active"><i class="fa fa-home"></i>
			<a class="lo text-white" href="bn_dashboard.php">Dashboard</a>
		</button>
    </div>
    <div class="v-divider"></div>
    <div class="btn-group d-flex">
    	<button type="button" class="btn btn-sm btn-success btn-block ">
		<i class="fa fa-plus-circle"></i><a class="lo text-white" href="bn_new_manifest.php">	File a New Manifest</a></button>
    </div>
	...
	<div class="btn-group d-flex">
      ...
      <div class="dropdown-menu" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:14px">
      	<a class="dropdown-item" href="view_manifest_records_for_registry.php"><i class="fa fa-certificate"></i>	Registry</a>
        <div class="dropdown-divider"></div>
      	<a class="dropdown-item" href="view_manifest_records_for_trustees.php"><i class="fa fa-handshake-o"></i>	Incorporated Trustees</a>
      </div>
    </div>
	<div class="v-divider"></div>
    <div class="btn-group d-flex">

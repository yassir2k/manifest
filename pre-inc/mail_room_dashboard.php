	...
	<head>
	  ...
	  <title>Mail Room Dashboard</title>
	</head>
   ...
   <?php require 'menus/menu_mail_room_dashboard.php';?>
   <!-- ---------------------------------------End of Navigation------------------------------------------- -->
        ...
        <div class="col-sm-8"> <!--Main Row Left-->
            <div class="row"><!--Manifest Statistics Registry-->
                ...
                <div class="col-sm-6" align="center">
                    <h6 class="text-success" align="center"><b>Today's Manifest Statistics (From Registry)</b></h6>
                </div>
                <div class="col-sm-3" align="center">
                    <hr class="separator">
                </div>
			...
			<?php 
				...
				//Total Awaiting Acknowledgement Mail Room
				$sql = "SELECT count(*) as Total FROM tbl_Registry where convert(varchar(10), ";
				...
				$sql = "SELECT count(*) as Total FROM tbl_Registry where convert(varchar(10), ";
				$sql.= "MR_Receiving_Date, 102) = convert(varchar(10), getdate(), 102) AND (REG_Despatch_Status = 'A-B-MR') AND State_Code='$scode'";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
			...
			<div class="row"><!--Beginning of Putting Up Stats For Registry-->
				...
				<?php 
				//Total Forwarded (By Incorporated Trustees)
				$sql = "SELECT count(*) as Total FROM tbl_Trustees where convert(varchar(10), ";
				$sql.= "IT_Manifest_Preparation_Date, 102) = convert(varchar(10), getdate(), 102) AND (IT_Despatch_Status = 'S-T-MR' AND State_Code='$scode'";
				$sql.= "OR IT_Despatch_Status = 'A-B-MR')";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
				...
				//Total Acknowledged by Mail Room
				$sql = "SELECT count(*) as Total FROM tbl_Trustees where convert(varchar(10), ";
				$sql.= "MR_Receiving_Date, 102) = convert(varchar(10), getdate(), 102) AND (IT_Despatch_Status = 'A-B-MR') AND State_Code='$scode'";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
			...
			<div class="row top-space20" ><!--Manifest Statistics IT-->
                ...
                <div class="col-sm-6" align="center">
                    <h6 class="text-success" align="center"><b>Today's Manifest Statistics (From IT)</b></h6>
                </div>
                <div class="col-sm-3" align="center">
                    <hr class="separator">
                </div>
        	...
        	</div><!--End of Putting Up Stats (IT)-->
			
			
			
            <div class="row"><!--Manifest Statistics Business Names-->
                <div class="col-sm-3" align="center">
                    <hr class="separator" >
                </div>
                <div class="col-sm-6" align="center">
                    <h6 class="text-success" align="center"><b>Today's Manifest Statistics (From Business Names)</b></h6>
                </div>
                <div class="col-sm-3" align="center">
                    <hr class="separator">
                </div>
        	</div><!--End of Manifest Statistics Business Names-->
			<?php 
				//Total Received From Business Names
				$sql = "SELECT count(*) as Total FROM tbl_Business_names where convert(varchar(10), ";
				$sql.= "BN_Cert_Despatch_Date, 102) = convert(varchar(10), getdate(), 102) AND (BN_Despatch_Status = 'S-T-MR' ";
				$sql.= " OR BN_Despatch_Status = 'A-B-MR') AND State_Code='$scode'";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
				...
				//Total Awaiting Acknowledgement Mail Room
				$sql = "SELECT count(*) as Total FROM tbl_Business_names where convert(varchar(10), ";
				$sql.= "BN_Cert_Despatch_Date, 102) = convert(varchar(10), getdate(), 102) AND BN_Despatch_Status = 'S-T-MR' AND State_Code='$scode'";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}
				...
				//Total Acknowledged by Mail Room
				$sql = "SELECT count(*) as Total FROM tbl_Business_names where convert(varchar(10), ";
				$sql.= "MR_Receiving_Date, 102) = convert(varchar(10), getdate(), 102) AND BN_Despatch_Status = 'A-B-MR' AND State_Code='$scode'";
				$result = sqlsrv_query($conn, $sql);
				if($result === false) {
					die(print_r(sqlsrv_errors(), true));
				}

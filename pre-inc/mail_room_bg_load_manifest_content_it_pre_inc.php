	...
	<table cellpadding="2" cellspacing="2" class="minitable" style="font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif">
						<thead style="background-color: #f00">
							<tr>
								...
								<th align = "left" width = "150">IT Staff</th>
							</tr>
						</thead>
<?php
	include ('../dbconnection.php');
	$sql = "SELECT Serial_No, RC_Number, Company_Name, MR_Receiving_Date, IT_Manifest_Prepared_By FROM tbl_Trustees ";
	$sql.="WHERE IT_Batch = '$batchcode' ";
			...
			while($row = sqlsrv_fetch_array($result))
			{
				?>
					<tr >
						...
						<td><?php echo $row['IT_Manifest_Prepared_By'];?></td>
					</tr>
				<?php
				$i++;
			}

...
$sql="";
for ($i = 0; $i < $count; $i++){
	$sql = "UPDATE tbl_Registry SET REG_Manifest_Prepared_By = '".$_SESSION['user']."', REG_Despatch_Status = 'S-T-MR', ";
	$sql.= "REG_Manifest_Preparation_Date = GETDATE(), REG_Batch = '".$data->cert_batch[$i]."' ";
...
$bc = $data->cert_batch[0]; //E.g. FCT-15072020005344-REG-BATCH-1
$substring ='-';
...
$event = "Forwarding of Manifest from Registry -> Mail Room";
//Insert Into DB
